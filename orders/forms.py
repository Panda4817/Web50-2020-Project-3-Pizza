...
class SignUpForm(UserCreationForm):
    ...
    street_address_2 = forms.CharField(max_length=64, help_text='Optional', required=False)
...
class CheckoutDetailsForm(forms.ModelForm):
    first_name = forms.CharField(max_length=64, help_text='Required', widget=forms.TextInput(attrs={'class': "form-control"}))
    last_name = forms.CharField(max_length=64, help_text='Required', widget=forms.TextInput(attrs={'class': "form-control"}))
    email = forms.EmailField(max_length=254, help_text='Required', widget=forms.EmailInput(attrs={'class': "form-control"}))
    street_address_1 = forms.CharField(max_length=64, help_text='Required', widget=forms.TextInput(attrs={'class': "form-control"}))
    street_address_2 = forms.CharField(max_length=64, help_text='Optional', required=False, widget=forms.TextInput(attrs={'class': "form-control"}))
    city = forms.CharField(max_length=64, help_text='Required', label="Town/City", widget=forms.TextInput(attrs={'class': "form-control"}))
    post_code = forms.CharField(max_length=64, help_text='Required', label="Postal Code/Zip Code", widget=forms.TextInput(attrs={'class': "form-control"}))
    tel = forms.CharField(max_length=64, help_text='Optional', required=False, widget=forms.TextInput(attrs={'class': "form-control"}))
